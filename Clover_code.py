...
def run_first_step(input_file_path):
    ...
    out_sheets = get_all_sheets('AIO Template.xlsx')
    inp_sheets = get_all_sheets('Clover Template.xlsx')
    ...
    excel_file_path = 'Clover Template.xlsx'  # Update with the path to your Excel file
